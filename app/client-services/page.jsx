                    ...
                    <div className="flex flex-wrap gap-3">
                      {service.links.map((link) => (
                        <Link
                          ...
                          className="inline-flex items-center gap-2 font-sans text-xs font-bold tracking-widest uppercase bg-secondary_color text-white px-5 py-2.5 rounded-sm hover:bg-[#0a2240] transition-colors no-underline"
                        >
                          {link.text}
                          <ExternalArrow />
                        </Link>
