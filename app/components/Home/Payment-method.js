...
const PaymentMethod = () => {
  return (
    <div className='p-6 py-24 bg-[url(/images/home/payment-image/bg-image.png)] bg-bottom rounded-lg shadow-md flex flex-col items-center justify-center h-full border'>
