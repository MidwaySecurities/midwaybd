    ...
    return (
        <div className="flex justify-between items-center bg-[#9999a1] p-4 text-white">
            <Link className={`${style.logoZoom} flex items-center gap-2 font-bold text-gray-800 text-[14px]`} href={`/`}>
                ...
                <h1 className="flex flex-col leading-5 justify-center uppercase"><span className="text-xl tracking-[2px]">Midway</span><span className="tracking-[.9px] text-[.6rem]">Securities Ltd.</span></h1>
            </Link>
