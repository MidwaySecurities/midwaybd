...
const SearchIcon = () => {
    return (
        <div className='h-8 bg-white my-6 mb-8 rounded-3xl relative'>
            ...
            <Image src={`https://cdn-icons-png.flaticon.com/512/17216/17216943.png`} width={20} height={10} className="w-6 h-6 absolute top-[50%] translate-y-[-50%] right-2 bg-white" />
        </div>
    )
}
