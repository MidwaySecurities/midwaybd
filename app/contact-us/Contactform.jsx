  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
      <div className="flex items-center mb-6">
        <Send className="w-6 h-6 text-secondary_color mr-3" aria-hidden="true" />
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-6">
        ...
        <button
          ...
          className="w-full bg-secondary_color hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
        >
          {isSubmitting ? (
            <>
