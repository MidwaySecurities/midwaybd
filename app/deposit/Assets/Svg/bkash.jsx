...
const Bkash = ({width, height}) => (
  ...
  >
    <defs>
      <style>
        {
          ".a{fill:red;stroke:#000000;stroke-linecap:round;stroke-linejoin:round;}"
        }
      </style>
    </defs>
    <path
    ...
    />
    <polyline className="a" points="37.929 20.855 43 20.855 39.368 17.445" />
    <polyline
      className="a"
