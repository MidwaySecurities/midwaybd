...
const ForeignInvestor = () => {
    return (
        <div className='px-4'>
            <div className='mt-4 card-shadow p-4 rounded-lg'>
            ...
            <div className='mt-8'>
                ...
                <Link className='font-bold underline wrap-break-word' href={`http://www.dsebd.org/pdf/facilities%20for%20for%20foreign%20investors.pdf`}>http://www.dsebd.org/pdf/facilities%20for%20for%20foreign%20investors.pdf</Link>
            </div>
